          ...
          {links.map((link) => {
            return (
              ...
              >
                <Link
                  className={clsx(
                    "flex w-full items-center  justify-center px-3 py-3 hover:text-gray-950 tra transition duration-[0.3s]",
                ...
                >
                  ...
                  {link.name === activeSection && (
                    <motion.span
                      ...
                      className="bg-gray-100 inset-0 -z-10 rounded-full absolute"
                    ></motion.span>
                  )}
                </Link>
              </motion.li>
